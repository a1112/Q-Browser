...
ApplicationFlowForm {
    ...
    function cappuccino() {
        ...
        applicationFlow.coffeeName = "卡布奇诺"
        ...
        coffeeText.text = "卡布奇诺"
    }
    function espresso() {
        applicationFlow.state = "Settings"
        applicationFlow.coffeeName = "浓缩咖啡"
        ...
        coffeeConfig.sugarAmount = 0
        stack.pushItem(settings, {appFlow: applicationFlow, coffeeConfig})
        coffeeText.text = "浓缩咖啡"
    }
    function latte() {
        applicationFlow.state = "Settings"
        applicationFlow.coffeeName = "拿铁"
    ...
    function macchiato() {
        applicationFlow.state = "Settings"
        applicationFlow.coffeeName = "玛奇朵"
    ...
    function continueButton() {
        ...
        if (applicationFlow.coffeeName == "卡布奇诺") {
            applicationFlow.cappuccinos = applicationFlow.cappuccinos - 1
        } else if (applicationFlow.coffeeName == "浓缩咖啡") {
            applicationFlow.espressos = applicationFlow.espressos - 1
        } else if (applicationFlow.coffeeName == "拿铁") {
